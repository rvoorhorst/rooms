...
from apps.base.forms import CommentForm, UserRegisterForm
...
class UserRegisterView(SuccessMessageMixin, CreateView):
    ...
    success_url = reverse_lazy("home")
    success_message = f"Your account was created successfully. Click <a href='accounts/login'>here</a> to login"
